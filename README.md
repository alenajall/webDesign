...
- Interactive Google Map on Contact page
- Circular player photos with hover effects
- Fixed navigation bar
- Beautiful black footer with social links
...
- about.html = Our Story, Vision, and Team
- contact.html - Contact form + Google Map + Follow Us
